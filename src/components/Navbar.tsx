...
const Navbar = () => {
  const {openCart , carsQuantity} = useCarsShopping()

  return (
    <NavbarBs sticky="top" className="shadow-lg navbar navbar-expand-lg navbar-light bg-danger">
        <Container>
            <Nav>
            ...
            <div className="rounded-circle bg-light text-danger "
                style={{
                    color: "white",
                    width: "1.5rem",
                    height: "1.5rem",
